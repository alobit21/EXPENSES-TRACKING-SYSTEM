          ...
          {session?.user ? (
            <>
              {getAvatarUrl(session.user as Author) && !imageError ? (
                ...
                <div className="w-10 h-10 rounded-full bg-blue-900 flex items-center justify-center border border-border dark:border-gray-600">
            ...
            <p className="text-gray-400 dark:text-gray-500">Please log in to create a post</p>
          )}
        </div>

        <div className="bg-card dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-border dark:border-gray-700">
