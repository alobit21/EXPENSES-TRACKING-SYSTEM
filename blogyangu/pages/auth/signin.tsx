...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <Card className="max-w-md w-full bg-gray-800 text-gray-100">
        <CardHeader>
          <CardTitle className="text-center text-3xl font-extrabold text-gray-100">
        ...
        <CardContent className="space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="group relative w-full flex justify-center items-center py-2 px-4 border border-gray-600 text-sm font-medium rounded-md bg-gray-700 text-white hover:bg-gray-600 disabled:opacity-50"
          >
            <svg
