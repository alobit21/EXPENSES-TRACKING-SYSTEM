  ...
  <div className="w-full md:w-1/2 mt-4 md:mt-0">
    ...
    />
          ...
          <button
            ...
            className="w-full flex justify-center items-center py-2 px-4 border border-gray-600 text-sm font-medium rounded-md bg-gray-700 text-white hover:bg-gray-600"
          >
            <svg
