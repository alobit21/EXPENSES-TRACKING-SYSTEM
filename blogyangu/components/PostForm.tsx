        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs">
              {errors.title ? (
                ...
                <span className="text-gray-400">{title.length}/200 characters</span>
              )}
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs">
              {errors.excerpt ? (
                ...
                <span className="text-gray-400">{excerpt.length}/300 characters</span>
              )}
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="bg-gray-900 border-gray-600 text-white file:bg-blue-600 file:text-white file:border-0"
            />
            {imageError && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-end space-x-2">
              ...
              />
              <Label htmlFor="allowComments" className="text-white cursor-pointer">
                Allow Comments
              </Label>
            </div>
          </div>
