...
export default function FeaturedPost({ post, ...props }: PostProps) {
  return (
    <article className="bg-card dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-border dark:border-gray-700">
      <PostContent 
        post={post} 
        imageHeight="h-96"
        titleSize="text-3xl"
      ...
      <div className="p-8">
        ...
        {props.isAdminOrAuthor && (
          <div className="flex space-x-3 mt-6 pt-6 border-t border-border dark:border-gray-700">
