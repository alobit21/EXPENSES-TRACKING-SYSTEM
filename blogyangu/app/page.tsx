        ...
        <div className="container mx-auto px-4 pt-20 pb-16 max-w-7xl relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-4 text-gray-300 text-lg max-w-xl">A professional, human-friendly blog where developers and creators share deep dives, quick tips, and opinions.</p>
              <div className="mt-8 flex gap-3">
                ...
                <a href="#newsletter" className="bg-gray-800 hover:bg-gray-700 text-white px-5 py-3 rounded-lg border border-gray-700 font-medium">Subscribe</a>
              </div>
              {categories?.length > 0 && (
          ...
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-4">
              ...
              <div className="text-gray-400 text-sm">Featured & Latest</div>
            </div>
            <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-4">
            ...
            <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-4">
              ...
              <div className="text-gray-400 text-sm">Open & inclusive</div>
            </div>
            <div className="bg-gray-800/60 border border-gray-700 rounded-xl p-4">
              <div className="text-3xl font-bold">No Ads</div>
              <div className="text-gray-400 text-sm">Focus on content</div>
            </div>
          </div>
        </div>
      </section>
