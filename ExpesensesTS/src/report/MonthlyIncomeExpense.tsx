  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 py-8 px-4 sm:px-6 lg:px-8">
     ...
     <div className="mb-8 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">Monthly Income vs Expense Report</h2>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className={`text-2xl font-bold ${
                        totalNetBalance >= 0 ? 'text-blue-700' : 'text-orange-700'
                      }`}>
                    ...
                    <tbody>
                      {monthlyIncomeExpense.map((item) => {
                        const savingsRate = item.totalIncome > 0 
                          ? ((item.netBalance / item.totalIncome) * 100).toFixed(1)
                          : '0.0';
                        ...
                        return (
                          ...
                          >
                            <td className="p-4 text-gray-700 font-medium">{item.month}</td>
