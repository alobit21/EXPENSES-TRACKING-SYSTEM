    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">{completedGoals} of {totalGoals} goals completed</p>
        </div>
        <button
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-green-600">${goal.currentAmount.toFixed(2)}</div>
                  <div className="text-xs text-gray-500">Saved</div>
                </div>
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <Target size={20} className="mx-auto mb-1 text-blue-600" />
                  <div className="text-lg font-bold text-blue-600">${goal.targetAmount.toFixed(2)}</div>
              ...
              {!isCompleted && (
                <button
                  ...
                  className="w-full bg-indigo-600 text-white py-2 px-4 rounded-lg flex items-center justify-center gap-2 hover:bg-indigo-700"
                >
                  <TrendingUp size={16} />
                  Contribute
                </button>
