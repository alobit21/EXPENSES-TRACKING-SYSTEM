...
export default function Testimonials() {
  return (
    <section
      className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gray-900 text-white"
      style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="relative bg-white/90 backdrop-blur-md border-l-4 border-indigo-500 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-300"
            >
              {/* Decorative Quote Icon */}
              <div className="absolute top-6 right-6 text-5xl text-gray-300 opacity-50">“</div>
